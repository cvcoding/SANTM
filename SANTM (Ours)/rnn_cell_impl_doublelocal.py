...
class RNNCell(base_layer.Layer):
  ...
  def __call__(self, inputs, state, input_t_gate, scope=None):
...
class DropoutWrapper(RNNCell):
  ...
  def __call__(self, inputs, state, input_t_gate_bottom, input_t_gate_top, scope=None):
    ...
    output, new_state = self._cell(inputs, state, input_t_gate_bottom, input_t_gate_top)
