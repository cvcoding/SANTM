...
def create_generic_flags():
    ...
    """
    # Generic flags
    tf.app.flags.DEFINE_string('model', 'skip_lstm', "Select RNN cell: {lstm, gru, skip_lstm, skip_gru}")
    tf.app.flags.DEFINE_integer("rnn_cells1", 32, "Number of RNN cells1.")
    tf.app.flags.DEFINE_integer("rnn_cells2", 32, "Number of RNN cells2.")
    tf.app.flags.DEFINE_integer("rnn_layers", 3, "Number of RNN layers.")
    tf.app.flags.DEFINE_integer('batch_size', 100, "Batch size.")
    tf.app.flags.DEFINE_float('learning_rate', 0.001, "Learning rate.")
    tf.app.flags.DEFINE_float('grad_clip', 5., "Clip gradients at this value. Set to <=0 to disable clipping.")
