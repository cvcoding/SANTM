...
transform_train = transforms.Compose([
    ...
    # transforms.RandomCrop(24, padding=0),
...
# x = trainset.data[13, 14]
# testset = torchvision.datasets.ImageFolder(root='./data/ILSVRC2012_img_val128_Subfolders', transform=transform_test)
...
net = net.to(device)
# net = torch.load('model4imagenet.pkl')
