import numpy as np
import random
from util.ops import randomly_split_data
from util.ops import one_hot_sequence
...
def load_data(dataset_name, seq_len=200):
    ...
    if dataset_name == 'freq':
        x, y = get_freq(30000, 1.0, seq_len, START_PERIOD, END_PERIOD, START_TARGET_PERIOD, END_TARGET_PERIOD)
        # return get_freq()
